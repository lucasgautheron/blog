...
FAVICONS = (
    ("icon", "/assets/icon-16.png", "16x16"),
    ("icon", "/assets/icon-32.png", "32x32"),
    ("icon", "/assets/icon-48.png", "48x48")
)
...
#     # 'site': '@website',         # twitter nick for the website
  'creator': '@lucasgautheron',     # Username for the content creator / author.
}
